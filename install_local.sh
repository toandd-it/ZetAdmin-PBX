...
echo '$api_url = "http://'$pbx_domain'/api/zetadmin_pbx/postback.php";' >> $webroot/$api_conf
...
echo 'bindaddr=0.0.0.0' >> $asterisk_etc/http.conf
echo 'bindport=8089' >> $asterisk_etc/http.conf
